...
SimulatorDispatcher.prototype._getLocalizedString = function (stringKey) {
    ...
    var deStringsMap = require('json-loader!./resources/Shim_lib_resources_de-DE.json');
    var enStringsMap = require('json-loader!!./resources/Shim_lib_resources_en-US.json');
    var esStringsMap = require('json-loader!./resources/Shim_lib_resources_es-ES.json');
    var jaStringsMap = require('json-loader!./resources/Shim_lib_resources_ja-JP.json');
    var frStringsMap = require('json-loader!./resources/Shim_lib_resources_fr-FR.json');
    var koStringsMap = require('json-loader!./resources/Shim_lib_resources_ko-KR.json');
    var ptStringsMap = require('json-loader!./resources/Shim_lib_resources_pt-BR.json');
    var zhStringsMap = require('json-loader!./resources/Shim_lib_resources_zh-CN.json');
